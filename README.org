...
Org-marginalia lets you write margine notes (marginalia) for any text files in a separate Org file.

[[./resources/images/2020-12-22T141331-OM-screen-shot-01.png]]
*Figure 1*. Left: main note; Right: margine notes in its marginalia file
...
- [[https://github.com/jkitchin/ov-highlight][ov-highlight]] :: John Kitchin's (author of Org-ref). Great UX for markers wiht hydra. Saves the marker info and comments directly wihtin the Org file as base64 encoded string. It uses overlays
